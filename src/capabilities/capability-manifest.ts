...
export const CAPABILITY_MANIFEST: Capability[] = [
	...
	{ api: 'registerMarkdownCodeBlockProcessor (inline AI widgets)', probe: 'registerMarkdownCodeBlockProcessor', status: 'planned', tier: 2, reason: 'Render live AI results inside notes via a fenced ai-* code block.' },
	{ api: 'EditorSuggest / AbstractInputSuggest (@-mentions)', probe: 'EditorSuggest', status: 'planned', tier: 2, reason: 'File/heading/block autocomplete + slash commands in the chat input.' },
