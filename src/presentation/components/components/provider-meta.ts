...
export function getProviderMeta(providerId: string): { label: string; iconSvg: string | null } {
	...
	const metaMap: Record<string, { label: string; iconSvg: string }> = {
		...
		'claude-code': {
			label: 'Claude Code',
			iconSvg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M4 4h16v16H4z" opacity=".2"/><path d="M8.5 7 5 12l3.5 5L10 15l-2-3 2-3-1.5-2zm7 0L14 9l2 3-2 3 1.5 2L19 12l-3.5-5zM4 2a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H4zm0 2h16v16H4V4z"/></svg>`
		},
		'google': {
			label: 'Google Gemini',
		...
		'codex': {
			label: 'Codex',
			iconSvg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M4 4h9v16H4z"/><path d="M15 4h5v16h-5z" opacity=".4"/></svg>`
		},
		'ollama': {
			label: 'Ollama',
		...
		'qwen-code': {
			label: 'Qwen Code',
			iconSvg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M3 4h18v4H3z"/><path d="M7 10h10v10H7z" opacity=".4"/><path d="M11 12h2v4h-2zM9 16h6v2H9z"/></svg>`
		},
		'openrouter': {
			label: 'OpenRouter',
